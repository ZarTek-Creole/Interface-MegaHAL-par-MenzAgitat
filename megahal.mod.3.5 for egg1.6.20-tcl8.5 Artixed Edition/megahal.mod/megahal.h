...
// Removed predefs useless for eggdrop port, find them back in old versions

#define DEFAULT "."
#define MHAL_MIN(a,b) ((a)<(b))?(a):(b)
...
static int timediff(struct timeval *, struct timeval *);
...
static int dcc_forgetword(struct userrec *, int, char *);
...
static int tcl_search(ClientData, Tcl_Interp *, int, char **);
static int tcl_make_words(ClientData, Tcl_Interp *, int, char **);
static int tcl_debug_output(ClientData, Tcl_Interp *, int, char **);
static int tcl_searchword(ClientData, Tcl_Interp *, int, char **);
static int tcl_find_word(ClientData, Tcl_Interp *, int, char **);
static int tcl_learn(ClientData, Tcl_Interp *, int, char **);
static int tcl_getreply(ClientData, Tcl_Interp *, int, char **);
static int tcl_learnfile(ClientData, Tcl_Interp *, int, char **);
static int tcl_learningmode(ClientData, Tcl_Interp *, int, char **);
static int tcl_talkfrequency(ClientData, Tcl_Interp *, int, char **);
static int tcl_setmegabotnick(ClientData, Tcl_Interp *, int, char **);
